...
def main(page):
    ...
    def upvote_arrow_click(some_post, likes, score):
    ...
    def downvote_arrow_click(some_post, likes, score):
        def appropriate_vote(_):
    ...
    for post in reddit.front.new():
        ...
        upvote_arrow.on_click = upvote_arrow_click(post, post.likes, score_text)
        ...
        downvote_arrow.on_click = downvote_arrow_click(post, post.likes, score_text)
