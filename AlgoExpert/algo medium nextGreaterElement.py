...
Additionally, your function should treat the input array as a circular array. A circular array wraps around itself as if it were connected end-to-end. So the next index after the last index in a circular array is the first index. This means that, for our problem, given array = [0, 0, 5, 0, 0, 3, 0], the next greater element after 3 is 5, since the array is circular.
...
def nextGreaterElement(array):
    ...
    for i in range(len(array)):
        ...
        while True:
            ...
            if array[sentry] > current:
                newArray.append(array[sentry])
                break
